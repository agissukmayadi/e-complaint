        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block"><?= strtoupper($admin['nama_petugas']); ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/data_user') ?>" class="nav-link <?php if ($title == "User") {
                                                                                                echo "active";
                                                                                            } ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/data_petugas') ?>" class="nav-link <?php if ($title == "Petugas") {
                                                                                                echo "active";
                                                                                            } ?>">
                                <i class="nav-icon fas fa-table"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/data_pengaduan') ?>" class="nav-link <?php if ($title == "Pengaduan") {
                                                                                                    echo "active";
                                                                                                } ?>">
                                <i class="nav-icon fas fa-table"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/data_faq') ?>" class="nav-link <?php if ($title == "FAQ") {
                                                                                            echo "active";
                                                                                        } ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/data_subject') ?>" class="nav-link <?php if ($title == "Subject") {
                                                                                                echo "active";
                                                                                            } ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/data_contact') ?>" class="nav-link <?php if ($title == "Contact") {
                                                                                                echo "active";
                                                                                            } ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/data_profile') ?>" class="nav-link <?php if ($title == "Profile") {
                                                                                                echo "active";
                                                                                            } ?>">
