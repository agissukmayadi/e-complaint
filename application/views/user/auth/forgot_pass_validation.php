    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100" style="padding: 150px;">
                ...
                <form class="login100-form" method="POST" action="<?= base_url('Auth_user/forgot_pass_validation') ?>">
                    <span class="login100-form-title">
                        Forgot Password
                    </span>

                    <div class="wrap-input100">
                        <input class="input100" type="email" name="email" placeholder="Email" id="email" name="email" value="<?= set_value('email') ?>" autocomplete="off">
                    ...
                    <div class="container-login100-form-btn">
                        <a href="<?= base_url('Auth_user') ?>">
                            <button class="" type="button" style="color:#106eea">
                                <i class="fa fa-home"></i> Back to Login
                            </button>
                        </a>
                    </div>
