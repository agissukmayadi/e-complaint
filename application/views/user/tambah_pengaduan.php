<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="form">
                    <form action="<?= base_url('User/tambah_pengaduan_aksi') ?>" class="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <small>*Jika ada (Ukuran maksimal 10MB)</small>
                                <?php
