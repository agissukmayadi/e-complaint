        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block"><?= strtoupper($petugas['nama_petugas']); ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?= base_url('petugas') ?>" class="nav-link <?php if ($title == "Dashboard") {
                                                                                        echo "active";
                                                                                    } ?> ">
                        ...
                        <li class="nav-item <?php if ($title == "Data Pengaduan") {
                                                echo "menu-open";
                                            } elseif ($title == "Verifikasi Pengaduan") {
                                                echo "menu-open";
                                            } ?>">
                            <a href="#" class="nav-link <?php if ($title == "Data Pengaduan") {
                                                            echo "active";
                                                        } elseif ($title == "Verifikasi Pengaduan") {
                                                            echo "active";
                                                        } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('petugas/data_pengaduan') ?>" class="nav-link <?php if ($title == "Data Pengaduan") {
                                                                                                            echo "active";
                                                                                                        } ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('petugas/data_pengaduan_verifikasi') ?>" class="nav-link <?php if ($title == "Verifikasi Pengaduan") {
                                                                                                                        echo "active";
                                                                                                                    } ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Verifikasi</p>
                        ...
                        <li class="nav-item <?php if ($title == "Data User") {
                                                echo "menu-open";
                                            } elseif ($title == "Verifikasi User") {
                                                echo "menu-open";
                                            } ?>">
                            <a href="#" class="nav-link <?php if ($title == "Data User") {
                                                            echo "active";
                                                        } elseif ($title == "Verifikasi User") {
                                                            echo "active";
                                                        } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('petugas/data_user') ?>" class="nav-link <?php if ($title == "Data User") {
                                                                                                        echo "active";
                                                                                                    } ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data</p>
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('petugas/data_verifikasi') ?>" class="nav-link <?php if ($title == "Verifikasi User") {
                                                                                                                echo "active";
                                                                                                            } ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Verifikasi</p>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('petugas/logout') ?>" class="nav-link">
